...
Then it gives candidate properties which appeared
to hold over those executions.
...
LLM is only generating candidates.

The predicted invariant is checked using
static analysis.
...
Then system may go back to the previous proof goal
...
If verifier establishes the required property,
we reach SUCCESS.
